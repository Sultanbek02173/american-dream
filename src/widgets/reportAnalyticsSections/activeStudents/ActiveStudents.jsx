      ...
      <div className='activeStudents_statistics'>
        <div className='activeStudents_statistics_header'>
          ...
          <div className='row main_stistic'>
            ...
            <div className='row activeStudents_statistics_header_progress'>
              ...
              <VerticalProgress progress={80} text={'+12'} />
              <p className='second_text'>Перестали ходить:</p>
              <VerticalProgress progress={80} text={'-4'} />
              <p className='third_text'>Средний возраст:</p>
              <VerticalProgress progress={80} text={'13.7 лет'} />
            </div>
          </div>
        </div>
        ...
        <div className='row activeStudents_statistics_lessons'>
          <div className='row item'>
            <p>Английский</p>
            <CircleProgress percentage={45} radius={100} stroke={30} color={'#313131'} />
          </div>
          <div className='row item'>
            <p>Математика</p>
            <CircleProgress percentage={30} radius={100} stroke={30} color={'#313131'} />
          </div>
          <div className='row item'>
            <p>Робототехника</p>
            <CircleProgress percentage={25} radius={100} stroke={30} color={'#313131'} />
          </div>
        </div>
      </div>
    </section>
